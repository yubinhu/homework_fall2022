...
class MBAgent(BaseAgent):
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        for i in range(self.ensemble_size):
            ...
            bg_idx = i * num_data_per_ens
            ed_idx = (i+1) * num_data_per_ens
            observations = ob_no[bg_idx:ed_idx]
            actions = ac_na[bg_idx:ed_idx]
            next_observations = next_ob_no[bg_idx:ed_idx]
